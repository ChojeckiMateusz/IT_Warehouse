...
public class addOrderController implements Initializable{
    ...
    public addOrderController() throws RemoteException, NotBoundException {
    }
    ...
    public void onAction() throws RemoteException, SQLException {
        ...
        testLabel.setText("Quantity: " + product.getQuantity() + " Price: " + product.getPrice());
    }

    public void setPrice() throws RemoteException, SQLException {
        ProductSerializer product = server.getProduct(orderProductComboBoxField.getValue());
        orderPriceLabel.setText(String.valueOf(product.getPrice() * Integer.parseInt(orderQuantityTextField.getText())));
    }
    ...
    private boolean validateQuantity() throws RemoteException, SQLException {
        ...
        if (orderQuantityTextField.getText().equals("")){
            ...
            if (Integer.parseInt(orderQuantityTextField.getText()) > product.getQuantity()) {
                orderQuantityError.setVisible(true);
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        orderCustomerComboBoxField.setValue(customers.get(0));
        System.out.println(orderCustomerComboBoxField.getValue());
        ...
        orderProductComboBoxField.setValue(products.get(0));
        System.out.println(orderProductComboBoxField.getValue());
    ...
    public void addButtonClicked() throws RemoteException, SQLException {
        ...
        if (if_next) {
            server.orderProductQuantity(orderProductComboBoxField.getValue(), orderQuantityTextField.getText());
            orderSuccessLabel.setText("Product added to database");
            ...
            OrderSerializer order = new OrderSerializer(user, orderCustomerComboBoxField.getValue(), orderProductComboBoxField.getValue(), orderQuantityTextField.getText(), orderCommentsTextField.getText());
